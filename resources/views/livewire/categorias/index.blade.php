...
<div>
    ...
    @if ($data->isEmpty())
        <div class="text-center mt-8">
            <p class="mb-4 text-2xl">Aún no hay categorias</p>
                    ...
                    @foreach ($data as $item)
                        <tr wire:key="{{ $item->id }}"
                            ...
                            <td class="px-6 py-4 flex gap-4">
                                ...
                                <a href="{{ route('categorias.edit', $item) }}" wire:navigate
    ...
    @if ($show)
        <x-modal-show title="Detalle del categoria">
    ...
    @if ($showDelete)
        <x-modal-destroy-confirm>
            <p class="mb-4">{{ $categoria->nombre }}</p>
        </x-modal-destroy-confirm>
    @endif
</div>
